...
export default function MarketingTemplate({
  badge, headline, subheadline, ctaText = 'Get Early Access', ctaHref = '/get-started',
    ...
    <PageLayout>
      ...
      <section className="relative bg-[hsl(222,47%,7%)] py-28 overflow-hidden">
        ...
        <div className="relative z-10 max-w-4xl mx-auto px-6 text-center">
          ...
          <h1 className="font-syne text-4xl md:text-6xl font-extrabold text-white leading-tight mb-6">
            {headline}
          </h1>
      ...
      <section className="py-24 bg-[hsl(222,47%,7%)]">
        <div className="max-w-2xl mx-auto px-6 text-center">
          ...
          <p className="text-white/40 mb-8">
            Join hundreds of MENA merchants already using TeyraPay.
          </p>
