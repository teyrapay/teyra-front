      ...
      <section className="relative bg-[hsl(222,47%,7%)] py-20 overflow-hidden">
        ...
        <div className="relative z-10 max-w-3xl mx-auto px-6">
          <span className="inline-block bg-primary/10 border border-primary/20 text-primary text-sm font-semibold px-4 py-1.5 rounded-full mb-6">
            {isAr ? 'قانوني · شروط الخدمة' : 'Legal · Terms of Service'}
          </span>
      ...
      <section className="py-16 bg-background">
        <div className="max-w-3xl mx-auto px-6 space-y-10">
          <p className="text-muted-foreground leading-relaxed">
            {isAr
              ? 'تحكم شروط الخدمة هذه وصولك إلى منصة TeyraPay واستخدامها. يرجى قراءتها بعناية قبل التسجيل أو معالجة أي مدفوعات.'
              : 'These Terms of Service govern your access to and use of the TeyraPay platform. Please read them carefully before registering or processing any payments.'}
          </p>
          {SECTIONS.map(s => (
            <div key={s.title}>
